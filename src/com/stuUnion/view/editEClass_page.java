...
public class editEClass_page extends JFrame {
	 ...
	 * Create the frame.
	 */
	public editEClass_page(String className, String term, String month) {
	...
	private void display() {
		...
		float grade1, grade2, grade3, grade4, total;
		...
		ec = cd.displayECList(ec);
		cd.closeDao();
		table.setValueAt(ec.getGrade1_1(), 0, 3);
		table.setValueAt(ec.getGrade1_2(), 1, 3);
		table.setValueAt(ec.getGrade1_3(), 2, 3);
		table.setValueAt(ec.getGrade1_4(), 3, 3);
		table.setValueAt(ec.getGrade1_5(), 4, 3);
		grade1 = ec.getGrade1_1() + ec.getGrade1_2() + ec.getGrade1_3() + ec.getGrade1_4() + ec.getGrade1_5();
		table.setValueAt(grade1, 5, 3);

		table.setValueAt(ec.getGrade2_1(), 6, 3);
		table.setValueAt(ec.getGrade2_2(), 7, 3);
		table.setValueAt(ec.getGrade2_3(), 8, 3);
		table.setValueAt(ec.getGrade2_4(), 9, 3);
		table.setValueAt(ec.getGrade2_5(), 10, 3);
		table.setValueAt(ec.getGrade2_6(), 11, 3);
		grade2 = ec.getGrade2_1() + ec.getGrade2_2() + ec.getGrade2_3() + ec.getGrade2_4() + ec.getGrade2_5()
				+ ec.getGrade2_6();
		table.setValueAt(grade2, 12, 3);

		table.setValueAt(ec.getGrade3_1(), 13, 3);
		table.setValueAt(ec.getGrade3_2(), 14, 3);
		table.setValueAt(ec.getGrade3_3(), 15, 3);
		table.setValueAt(ec.getGrade3_4(), 16, 3);
		table.setValueAt(ec.getGrade3_5(), 17, 3);
		table.setValueAt(ec.getGrade3_6(), 18, 3);
		grade3 = ec.getGrade3_1() + ec.getGrade3_2() + ec.getGrade3_3() + ec.getGrade3_4() + ec.getGrade3_5()
				+ ec.getGrade3_6();
		table.setValueAt(grade2, 19, 3);
	...
	protected void editEClass(ActionEvent aeec) {
		// TODO Auto-generated method stub
		...
		ec.setTotal(total);
		ClassDao cd = new ClassDao();
		if(cd.updateEClass(ec) && cd.updateEGrade(ec)) {
